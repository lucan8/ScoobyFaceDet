...
class Parameters:
    def __init__(self):
        self.env_dir = os.path.dirname(os.path.dirname(__file__))
        self.base_dir = os.path.dirname(os.path.dirname(self.env_dir))
        ...
        self.dir_save_files = os.path.join(self.env_dir, 'saved_files')
